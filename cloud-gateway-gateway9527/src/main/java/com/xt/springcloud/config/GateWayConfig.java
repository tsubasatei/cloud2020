...
public class GateWayConfig {
    ...
    public RouteLocator customRouterLocator(RouteLocatorBuilder builder) {
        ...
        routes.route("path_route_xt", r -> r.path("/guonei").uri("http://news.baidu.com/guonei")).build();
        return routes.build();
    }
    ...
    public RouteLocator customRouterLocator2(RouteLocatorBuilder builder) {
        RouteLocatorBuilder.Builder routes = builder.routes();
        routes.route("path_route_xt2", r -> r.path("/guoji").uri("http://news.baidu.com/guoji")).build();
        return routes.build();
    }
}
